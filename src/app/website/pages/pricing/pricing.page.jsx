    ...
    <>
      ...
      >
        ...
        <div className="w-full h-full flex flex-col lg:flex-row justify-center items-center">
          ...
          <div className="w-[60%] h-[4px] bg-[#A881D4] my-4 lg:hidden"></div>{" "}
          {/** Divider */}
          <div className="w-[90%] lg:w-[35%] h-[600px] p-2 flex flex-col justify-around items-center border-2 border-[#6C2E9C] rounded-xl">
            ...
            <Link
              to="/register"
              onClick={() => setNewPlanProspect(true)}
              className="w-[55%] border-2 border-[#6C2E9C] text-[#6C2E9C] text-center p-2 rounded-lg my-1 text-xl active:scale-[0.90] hover:text-[#A881D4] hover:border-[#A881D4] hover:scale-[1.01] transition-transform ease duration-100"
            >
              Start for free
            </Link>
          </div>
          ...
          <div className="w-[90%] lg:w-[35%] h-[600px] p-2 flex flex-col justify-around items-center border-2 border-[#6C2E9C] rounded-xl">
            <div className="w-[75%] flex flex-row justify-center items-center p-2 border-b-4 border-[#6C2E9C] my-1">
              <h2
                data-testid="plus-card-title"
                className="text-3xl text-[#A881D4]"
              >
                Plus+ deal
              </h2>
            </div>
            <div className="w-full flex flex-row justify-center items-center p-4 my-1">
              <span
                data-testid="plus-card-price"
                className="text-6xl text-[#6C2E9C]"
              >
                15$
              </span>
              <span
                data-testid="plus-card-month"
                className="text-xl text-[#6C2E9C]"
              >
                /month
              </span>
            </div>
            <p
              data-testid="plus-descrip"
              className="w-[90%] text-[#A881D4] text-lg"
            >
            ...
            <div className="w-[90%] flex flex-col justify-center items-center my-2 p-1 text-[#A881D4] text-xl">
              <div
                data-testid="plus-plan-option"
                className="w-full flex flex-row justify-start items-center my-4"
              >
                <i className="fa-light fa-circle-check mr-2 text-green-500"></i>
      ...
      <div className="hidden w-full p-5 lg:flex flex-col items-center bg-website-company-section">
        <RevealOnScroll>
          <div className="w-full flex flex-row justify-center items-center p-1 lg:mb-20">
            <h2 className="text-4xl text-[#A881D4] border-b-2 border-[#A881D4]">
              Join them and all the others.
            </h2>
          </div>
