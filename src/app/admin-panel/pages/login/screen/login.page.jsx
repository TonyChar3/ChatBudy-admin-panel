...
const LogInPage = () => {
  ...
  const SignUpUser = async (e) => {
    ...
    if (user_data.email === "" || user_data.password === "") {
      setModalOpen(true);
      setModalMsg(
        "ERROR: Missing credentials. Please provide your email and your password"
      );
    ...
    <>
      ...
      >
        ...
        <div className="lg:w-1/2 lg:flex lg:flex-row lg:justify-center">
          <form
            onSubmit={SignUpUser}
            className={`lg:w-1/2 md:w-96 w-80 p-2 flex flex-col justify-center items-center bg-white bg-opacity-30 backdrop-filter`}
          >
            <div className="w-full flex flex-col justify-center items-center my-1 text-[#A881D4]">
              ...
              <h2 className="text-sm p-1">Connect to continue</h2>
            </div>
            ...
            <button
              type="submit"
              className="bg-[#6C2E9C] p-2 text-lg text-white font-light rounded-xl w-[30%] lg:w-[40%] text-center mb-3 lg:text-xl"
            >
              Connect
            </button>
            <span className="mt-2">
              ...
              <Link
                to="/register"
                className="p-2 underline text-lg text-[#A881D4] font-light"
              >
                Register here
              </Link>
            </span>
