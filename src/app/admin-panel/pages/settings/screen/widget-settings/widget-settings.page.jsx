...
const WidgetCustomizationSection = ({ close_page_desktop }) => {
  const {
  ...
  const setNewCustomColor = () => {
    ...
    if (
      mock_widget_state.custom_R.length > 0 ||
      mock_widget_state.custom_G.length > 0 ||
      mock_widget_state.custom_B.length > 0 ||
      mock_widget_state.hex_input.length > 0
    ) {
      if (mock_widget_state.hex_input.length > 0) {
        ...
        // convert it into hex #
        const hex_code = RgbToHex(
          mock_widget_state.custom_R || mock_widget_state.R,
          mock_widget_state.custom_G || mock_widget_state.G,
          mock_widget_state.custom_B || mock_widget_state.B
        );
        setMockState((prevValues) => ({
          ...prevValues,
      ...
      >
        ...
        <div
          ...
          className={`${
            ui_state.open_customization
              ? "border-red-500 z-[80]"
              : "border-[#6C2E9C] z-0"
          } absolute w-[14%] md:w-[11%] lg:w-[9%] h-[8%] top-[2%] left-[45%] flex flex-row justify-center items-center rounded-full p-2 border-2 active:scale-[0.90] ease-in-out transition-all duration-100 bg-white cursor-pointer`}
        >
          <i
            className={`${
              ui_state.open_customization
                ? "fa-solid fa-xmark text-red-500"
                : "fa-regular fa-paintbrush-fine text-[#A881D4]"
            } text-2xl md:text-3xl lg:text-3xl transition-all ease`}
          ></i>
        </div>
        ...
        <div
          className={`absolute w-full h-full justify-center items-center ${
            ui_state.open_customization
              ? "translate-y-0 z-[70] flex bg-white bg-opacity-80 duration-300"
              : "translate-x-full opacity-0 duration-100 z-0"
        ...
        >
            ...
            <div className="flex flex-row justify-center items-center w-20 lg:w-40">
              <i
                className={`fa-sharp fa-solid fa-chevron-up text-xl ${
                  active_section === "widget_position" ? "rotate-180" : ""
          ...
          >
            ...
            >
              <span
                onClick={() =>
                  addNewCustomization("position", "widget_position", "left")
                }
                className={`text-lg cursor-pointer ${
                  mock_widget_state.widget_position === "left"
                    ? "border-b-2 border-[#6C2E9C]"
                    : ""
                }`}
              >
                Left
              ...
              <span
                onClick={() =>
                  addNewCustomization("position", "widget_position", "right")
                }
                className={`text-lg cursor-pointer ${
                  mock_widget_state.widget_position === "right"
                    ? "border-b-2 border-[#6C2E9C]"
                    : ""
                }`}
              >
          ...
          {/* Shape */}
          <div
            onClick={() => toggleCustomizationSections("widget_shape")}
            className={`flex flex-row w-80 my-3 p-2 border-2 border-[#6C2E9C] text-[#A881D4] rounded-lg lg:w-2/4 ${
              active_section === "widget_shape" ? "z-20" : "z-0"
            } bg-white active:scale-[0.90] transition-all ease-in-out duration-[0.3] cursor-pointer`}
          >
            <div className="w-60 text-center flex flex-row justify-center items-center lg:w-5/6">
            ...
            <div className="flex flex-row justify-center items-center w-20 lg:w-40">
              <i
                className={`fa-sharp fa-solid fa-chevron-up text-xl ${
                  active_section === "widget_shape" ? "rotate-180" : ""
                } duration-300 lg:text-2xl cursor-pointer`}
              ></i>
            </div>
          </div>
          ...
          >
            ...
            >
              <div
                onClick={() =>
                  addNewCustomization("shape", "widget_shape", "square")
                }
                className={`relative bg-[#A881D4] w-[50px] h-[50px] flex flex-row justify-center items-center rounded-lg shadow-md shadow-black active:scale-[0.90] cursor-pointer ${
                  mock_widget_state.widget_shape === "square"
                    ? "border-b-2 border-[#6C2E9C]"
                    : ""
                }`}
              >
                ...
                <div
                  className={`absolute w-4 h-4 bottom-10 left-10 rounded-full bg-[#6C2E9C] ${
                    mock_widget_state.widget_shape === "square" ? "" : "hidden"
                  }`}
                ></div>
              </div>
              <div
                onClick={() =>
                  addNewCustomization("shape", "widget_shape", "circle")
                }
                className={`relative bg-[#A881D4] w-[50px] h-[50px] flex flex-row justify-center items-center rounded-full shadow-md shadow-black active:scale-[0.90] cursor-pointer ${
                  mock_widget_state.widget_shape === "circle"
                    ? "border-b-2 border-[#6C2E9C]"
                    : ""
                }`}
              >
                ...
                <div
                  className={`absolute w-4 h-4 bottom-10 left-10 rounded-full bg-[#6C2E9C] ${
                    mock_widget_state.widget_shape === "circle" ? "" : "hidden"
                  }`}
                ></div>
              </div>
            </div>
          ...
          {/* Bg color */}
          <div
            onClick={() => toggleCustomizationSections("widget_bg_color")}
            className={`flex flex-row w-80 my-3 p-2 border-2 border-[#6C2E9C] text-[#A881D4] rounded-lg w-80 lg:w-2/4 ${
              active_section === "widget_bg_color" ? "z-20" : "z-0"
            } bg-white active:scale-[0.90] transition-all ease-in-out duration-[0.3] cursor-pointer`}
          >
            <div className="w-60 text-center flex flex-row justify-center items-center lg:w-5/6">
            ...
            <div className="flex flex-row justify-center items-center w-20 lg:w-40">
              <i
                className={`fa-sharp fa-solid fa-chevron-up text-xl ${
                  active_section === "widget_bg_color" ? "rotate-180" : ""
                } duration-300 lg:text-2xl cursor-pointer`}
              ></i>
            </div>
          </div>
          <div
            className={`flex flex-row w-full p-2 my-2 justify-center items-center ${
              active_section === "widget_bg_color"
                ? "static translate-x-0 z-[100] duration-300"
                : "absolute translate-x-[200px] -z-20 h-0"
            }`}
          >
...
export default WidgetCustomizationSection;
