...
const Modal = () => {
    ...
    return isVisible ? (
        <>
            <div className={`absolute z-[100] bottom-[16%] left-[3%] lg:left-auto lg:bottom-[90%] lg:right-[3%] w-auto bg-white shadow-lg ${errorMode? 'shadow-red-500' : 'shadow-[#33b8b8]'} m-2 rounded-lg ${isModalOpen ? '' : 'translate-x-[-200px] opacity-0 lg:translate-x-[200px]'} duration-700`}>
