...
const Modal = () => {
    ...
    return isVisible ? (
        <>
            <div className={`absolute z-50 bottom-[16%] left-[3%] lg:left-auto lg:bottom-[90%] lg:right-[3%] w-auto bg-white shadow-lg shadow-[#33b8b8] m-2 rounded-lg ${isModalOpen ? '' : 'translate-x-[-200px] opacity-0 lg:translate-x-[200px]'} duration-700`}>
