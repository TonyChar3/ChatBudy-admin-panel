        ...
        <>
            <div className={`${is_passwordauth_modal_open? 'absolute' : 'hidden'} z-50 left-0 right-0 w-full h-full flex flex-row justify-center items-center bg-black bg-opacity-20`}>
                <div className={`w-[90%] lg:w-[20%] flex flex-col justify-center items-center text-center p-2 rounded-lg bg-white shadow-lg border-2 ${error_mode? 'shadow-red-500 border-red-500' : 'shadow-black border-[#33b8b8]'}`}>    
                    ...
                    <button type="button" onClick={PasswordAuth} className="w-[30%] p-1 my-1 text-md text-white bg-[#33b8b8] rounded-xl active:scale-[0.90] duration-200 ease-in-out">Authenticate</button>
                    <button type="button" onClick={PasswordAuthCancel} className="w-[30%] p-1 m-1 text-md text-red-500 bg-white border-red-500 border-[1px] rounded-xl active:scale-[0.90] duration-200 ease-in-out">Cancel</button>
                </div>
            </div>
        </>
    )
