            ...
            <div className="flex flex-col min-h-full bg-white">
                ...
                ${ui_state.user_scroll ? 'lg:bg-white lg:p-3 lg:shadow-md lg:shadow-[#A881D4] z-20' : ''}`}>
                    ...
                    <div className="flex flex-col lg:flex-row lg:justify-around lg:items-center lg:w-1/4 lg:h-auto ml-2 justify-around h-20">
                        <NavLink to="/login" className="text-lg lg:text-xl mb-4 lg:mb-0 text-[#A881D4] active:scale-[0.90] transition-all ease">Login</NavLink>
                        <NavLink to="/register" className="hidden lg:block bg-[#6C2E9C] p-2 lg:text-xl text-white font-light rounded-xl w-[50%] text-center active:scale-[0.90] transition-all ease">Get started</NavLink>
                    </div>
                </nav>
