        ...
        <>
            ...
            > 
                ...
                <div className="lg:w-1/2 flex flex-col h-full justify-center items-center">
                    ...
                    <form className={`w-80 md:w-96 lg:w-2/4 p-2 my-4 flex flex-col justify-center items-center border-[1px] bg-white bg-opacity-30 backdrop-filter backdrop-blur-sm shadow-lg ${ui_state.error_mode? 'shadow-red-500 border-red-500' : 'shadow-[#33b8b8] border-[#33b8b8]'}`}>
                        <div className="w-full flex justify-center m-4">
                            <h1 className="text-center text-2xl text-black font-light md:text-3xl lg:text-3xl">
                                Start for 
                                <span className="text-[#33b8b8] underline">
                                    FREE
                                </span>
                            </h1>
                        </div>
                        <div className="w-full flex justify-center m-3 md:m-4 lg:m-5">
                            <input 
                            type="text" 
                            ...
                            className="p-2 md:p-3 lg:p-3 pl-2 border-[1px] border-[#33b8b8] lg:border-white w-5/6 bg-white bg-opacity-10 backdrop-filter backdrop-blur-sm shadow-md shadow-[#33b8b8] outline-none"
                            />
                        </div>
                        <div className="w-full flex justify-center m-3 md:m-4 lg:m-5">
                            <input 
                    ...
                    <form onSubmit={RegisterUser} className={`relative w-80 md:w-96 lg:w-2/4 p-2 my-4 flex flex-col justify-center items-center border-[1px] bg-white bg-opacity-30 backdrop-filter backdrop-blur-sm shadow-lg ${ui_state.error_mode? 'shadow-red-500 border-red-500' : 'shadow-[#33b8b8] border-[#33b8b8]'}`}>
                        <div className="w-full flex justify-center m-3 mt-4 md:m-4 md:mt-6 lg:m-5 lg:mt-8">
                            <input 
                            ...
                            className={`p-2 md:p-3 lg:p-3 pl-2 border-[1px] border-[#33b8b8] lg:border-white w-5/6 bg-white bg-opacity-10 backdrop-filter backdrop-blur-sm shadow-md shadow-[#33b8b8] outline-none`}
                            />
                            <span className="absolute p-1 top-[14%] right-10 md:p-2 md:top-[15%] lg:p-2 lg:right-[12%] lg:top-[16%] cursor-pointer">
                        ...
                        <div className="w-full flex justify-center m-2">
                            ...
                            className="p-3 md:p-5 lg:p-6 pl-2 border-[1px] border-white w-4/6 rounded-2xl bg-[#33b8b8] bg-opacity-10 backdrop-filter backdrop-blur-sm outline-none"
                            />
                        </div>
                        <button type="submit" className="bg-[#33b8b8] p-1 md:p-2 lg:p-2 text-white text-lg md:text-xl lg:text-xl font-light rounded-lg w-[30%] text-center m-3">Start now</button>
                    </form>
