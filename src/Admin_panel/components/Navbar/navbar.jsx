    ...
    return(
        <>
            <div className="lg:flex lg:flex-row h-full w-full">
                <div className={`absolute bottom-10 lg:static w-screen lg:w-[4%] lg:h-screen flex flex-col justify-center items-center z-20 lg:z-10 ${Object.keys(mobile_chat_room).length > 0? 'hidden' : ''}`}>
