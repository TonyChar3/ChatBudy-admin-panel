...
const SettingsPage = () => {
    ...
    return(
        <>
            <motion.div 
                className="w-full h-full lg:w-1/2 flex flex-col justify-center items-center bg-[#c3fffc]"
            ...
            >
                    ...
                    <div onClick={() => setOpenPage('widget_customization')} className="hidden lg:w-[45%] lg:flex lg:flex-row lg:justify-around lg:items-center text-center m-4 p-2 rounded-xl border-[1px] border-[#33b8b8] shadow-md shadow-[#33b8b8] bg-white lg:active:scale-[0.90] duration-200 ease-in-out cursor-pointer">
                    ...
                    <div className="w-80 lg:hidden text-center m-4 p-1 md:p-2 rounded-xl border-[1px] border-[#33b8b8] shadow-md shadow-[#33b8b8] bg-white lg:active:scale-[0.90] duration-200 ease-in-out">
                        <Link to="/navbar/chatroom_customization" className="flex flex-row justify-around items-center lg:hidden">
                            <h3 className="text-lg md:text-xl">Chatroom style<i className="fa-regular fa-message-captions ml-2"></i></h3>
                            <i className="fa-solid fa-chevron-right"></i>
                        </Link>
                    </div>
                    ...
                    <button onClick={() => LogOut()}  className="w-[35%] lg:w-[20%] p-1 mt-2 md:mt-3 lg:mt-2 border-[1px] border-[#33b8b8] shadow-md shadow-[#33b8b8] bg-white rounded-xl acitve:scale-[0.90] duration-100 ease-in text-lg hover:text-red-500">
                        Disconnect
