...
const LogInPage = () => {
    ...
    return(
        <>
            ...
            > 
                <div className="absolute top-5 right-6 md:top-7 md:right-8 rounded-xl lg:hidden">
                ...
                <div className="lg:w-1/2 lg:flex lg:flex-row lg:justify-center">
                    <form onSubmit={SignUpUser} className={`lg:w-1/2 md:w-96 w-80 p-2 flex flex-col justify-center items-center border-[1px] bg-white bg-opacity-30 backdrop-filter backdrop-blur-sm shadow-lg ${ui_state.error_mode? 'shadow-red-500 border-red-500' : 'shadow-[#33b8b8] border-[#33b8b8]'}`}>
                        ...
                        <div className="w-full flex justify-center m-4 md:m-6 lg:m-8">
                            ...
                            className="p-2 md:p-3 lg:p-3 pl-2 border-[1px] border-[#33b8b8] lg:border-white w-5/6 bg-white bg-opacity-10 backdrop-filter backdrop-blur-sm shadow-lg shadow-[#33b8b8] outline-none md:text-lg lg:text-lg"
                            />
                        </div>
                        <div className="w-full flex flex-col justify-center items-center mt-4">
                            ...
                            className="p-2 md:p-3 lg:p-3 pl-2 border-[1px] border-[#33b8b8] lg:border-white w-5/6 bg-white bg-opacity-10 shadow-[#33b8b8] shadow-md outline-none md:text-lg lg:text-lg"
                            />
                        ...
                        <button type="submit" className="bg-[#33b8b8] p-1 text-white font-light rounded-lg w-[30%] text-center mb-3 lg:p-2 md:text-lg lg:text-xl">
                            Connect
                        </button>
