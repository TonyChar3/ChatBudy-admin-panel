...
const SpinningLoaderPage = () => {
  ...
  return (
    <>
      <motion.div
        className={`absolute z-50 flex items-center justify-center h-screen w-screen bg-white transition-all ease ${
          show_loader ? "" : "hidden"
        }`}
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        ...
        <div className="absolute bottom-20 left-10 lg:left-[10%] lg:bottom-[15%] rounded-xl">
          <img
            src="https://res.cloudinary.com/dskpbps9l/image/upload/v1698260563/ChatBudy.io/Increase_Your_Sales_16_mfgnnp.png"
            width="150"
            height="150"
            alt="canva image"
