    ...
    return(
        <>
            ...
            >
                ...
                <div onClick={OpenCustomizations} className={`${ui_state.open_customization? 'border-red-500 z-[80]' : 'border-[#33b8b8] z-0'} absolute w-[14%] lg:w-[9%] h-[8%] top-[2%] left-4 flex flex-row justify-center items-center rounded-full p-2 border-2 active:scale-[0.90] ease-in-out transition-all duration-100 bg-white cursor-pointer`}>
                    <i className={`${ui_state.open_customization? 'fa-solid fa-xmark text-red-500' : 'fa-regular fa-paintbrush-fine text-[#33b8b8]'} text-2xl lg:text-3xl transition-all ease`}></i>
                </div>
