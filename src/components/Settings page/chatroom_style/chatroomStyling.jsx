...
const ChatRoomStylingSection = () => {
    ...
    return (
        <>
            ...
            >
                <div onClick={openCustomizations} className={`${open_customization? 'border-red-500' : 'border-[#33b8b8]'} absolute w-[14%] lg:w-[9%] h-[8%] top-[2%] left-4 flex flex-row justify-center items-center rounded-full p-2 border-2 active:scale-[0.90] ease transition-all duration-300 bg-white ${open_customization? 'z-[40]' : 'z-0'} cursor-pointer`}>
