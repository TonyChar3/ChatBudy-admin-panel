        ...
        <>
            ...
            > 
                ...
                <div className="lg:w-1/2 lg:flex lg:flex-row lg:justify-center">
                    ...
                    <form className="w-80 lg:w-2/4 p-2 flex flex-col justify-center items-center border-[1px] border-[#33b8b8] bg-white bg-opacity-30 backdrop-filter backdrop-blur-sm shadow-lg shadow-[#33b8b8]">
                        ...
                        <div className="w-full flex justify-center m-3 lg:m-5">
                            <motion.input whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.90 }} whileFocus={{ scale: 1.05 }} type="text" placeholder='Full name' className="p-1 lg:p-3 pl-2 border-[1px] border-white w-5/6 bg-white bg-opacity-10 backdrop-filter backdrop-blur-sm shadow-md shadow-[#33b8b8] outline-none"/>
                        </div>
                        <div className="w-full flex justify-center m-3 lg:m-5">
                            <motion.input whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.90 }} whileFocus={{ scale: 1.05 }} type="text" placeholder='Email' className="p-1 lg:p-3 pl-2 border-[1px] border-white w-5/6 bg-white bg-opacity-10 backdrop-filter backdrop-blur-sm shadow-md shadow-[#33b8b8] outline-none"/>
                        </div>
                        <div className="w-full flex justify-center m-3 lg:m-5 lg:mt-8 mt-4">
                            <motion.input whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.90 }} whileFocus={{ scale: 1.05 }} type="text" placeholder='Password' className="p-1 lg:p-3 pl-2 border-[1px] border-white w-5/6 bg-white bg-opacity-10 backdrop-filter backdrop-blur-sm shadow-md shadow-[#33b8b8] outline-none"/>
                        </div>
                        ...
                        <Link to="/navbar/visitors" className="bg-[#33b8b8] p-1 lg:p-2 text-white text-lg lg:text-2xl font-light rounded-lg w-[30%] text-center m-3">Sign-up</Link>
