...
const VisitorCard = ({ id, name, email, browser, country, time, onRemoveVisitor }) => {
    ...
    return(
        <>
            <div className="w-[95%] relative flex flex-row justify-around p-2 my-3 border-[1px] border-[#33b8b8] rounded-xl shadow-md shadow-[#33b8b8] bg-white">
                ...
                <div className={`absolute z-10 right-[11%] top-0 lg:right-[6%] lg:top-1 p-2 flex flex-row items-center justify-between w-[14%] lg:w-[8%] text-sm text-center ${open_actions? '':'scale-0'} duration-300`}>
